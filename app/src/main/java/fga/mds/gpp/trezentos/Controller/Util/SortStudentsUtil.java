...
public class SortStudentsUtil {
    ...
    * @params: none
    * @return: Map representing key(String) being the email and the value(Double) being the score
    * */
    public static Map<String, Double> sortGroups(){
    ...
    /*
    * Purpose: Method that creates a new student map
    ...
    * */
    public static List<Map.Entry<String,Double>> sortByTestScore(Map<String, Double> mapStudents){
        ...
        List<Map.Entry<String, Double>> list = new ArrayList<>(mapStudents.entrySet());
